    ...
    <div className={`product-item ${className}`}>
      ...
      <div className="product-price">
        ...
        <div className="quickshop" onClick={() => openModal(product.id)}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="70px" height="70px" viewBox="0 0 442.04 442.04" xmlSpace="preserve">
